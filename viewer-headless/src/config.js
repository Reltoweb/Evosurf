...
function readConfig() {
    ...
    return {
        ...
        operationTimeoutMs: Number(process.env.OPERATION_TIMEOUT_MS || 30000),
        cleanupTimeoutMs: Number(process.env.CLEANUP_TIMEOUT_MS || 10000),
        missionRecoveryGraceMs: Number(process.env.MISSION_RECOVERY_GRACE_MS || 60000),
